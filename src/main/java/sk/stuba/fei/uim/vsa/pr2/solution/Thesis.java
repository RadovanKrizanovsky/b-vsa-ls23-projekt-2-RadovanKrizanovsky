...
@NamedQuery(
  name = Thesis.FIND_ALL_BY_AUTHOR,
  query = "select t from Thesis t where t.author.aisId = :studentId"
)
@NamedQuery(
  name = Thesis.FIND_ALL_BY_SUPERVISOR,
  query = "select t from Thesis t where t.supervisor.aisId = :teacherId"
)
public class Thesis implements Serializable {
  ...
  public static final String FIND_ALL_BY_SUPERVISOR =
    "Thesis.findAllBySupervisor";
